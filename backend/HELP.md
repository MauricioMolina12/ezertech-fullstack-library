...
* The original package name 'com.project.library-backend' is invalid and this project uses 'com.project.library_backend' instead.
...
* [Spring Cache Abstraction](https://docs.spring.io/spring-boot/4.0.7/reference/io/caching.html)
